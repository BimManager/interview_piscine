...
int main(void)
{
	...
	printf("price for the art \'%s\' is %d\n",
		   "Foo", searchPrice(arts, n, "Foo"));
	printf("price for the art \'%s\' is %d\n",
		   "23", searchPrice(arts, n, "23"));
	printf("price for the art \'%s\' is %d\n",
		   " Miserere", searchPrice(arts, n, " Miserere"));
	printf("price for the art \'%s\' is %d\n",
		   "\"AIKO MIYAWAKI/1960-1980\"",
		   searchPrice(arts, n, "\"AIKO MIYAWAKI/1960-1980\""));
	printf("price for the art \'%s\' is %d\n",
		   "\"As the Report of Hilter's Death Was Recieved in the City\"",
		   searchPrice(arts, n, "\"As the Report of Hilter's Death Was Recieved in the City\""));
	printf("price for the art \'%s\' is %d\n",
		   "Živé Obrazy", searchPrice(arts, n, "Živé Obrazy"));
	printf("price for the art \'%s\' is %d\n",
		   "Title", searchPrice(arts, n, "Title"));
	return (0);
}
